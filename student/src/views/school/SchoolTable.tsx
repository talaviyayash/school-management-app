...
import type { ApiSchoolsListResponse, SchoolListResponse, SchoolType } from '@/types/schoolTypes'
...
const description: DescriptionItem<SchoolType>[] = [
  ...
  },
  {
    ...
    Cell: ({ row }) => <Typography>{row.address}</Typography>
  },
...
const SchoolTable = () => {
  ...
  const getData = async (page: number) => {
    const response = await api<ApiSchoolsListResponse>({
      endPoint: `/school`,
      needLoader: true,
